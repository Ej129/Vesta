...
export const VestaLogo = ({ className }: { className?: string }) => (
    <svg
      ...
      aria-label="Vesta Logo"
      role="img"
    >
      <g clipPath="url(#clip0_1_2)">
        <path
          d="M173.284 497.265L0.999998 398.212V48.7339L86.8044 2V345.192L173.284 398.212L258.387 345.192V2L344.192 48.7339V391.926L173.284 497.265Z"
          fill="#B11116"
        />
        <mask
          id="mask0_1_2"
        ...
        >
          <path
            d="M114.778 215.469H231.99V305.248H114.778V215.469Z"
            fill="white"
          />
        </mask>
        <g mask="url(#mask0_1_2)">
          <path
            d="M208.766 248.649C208.766 255.975 202.823 261.917 195.498 261.917C188.172 261.917 182.23 255.975 182.23 248.649C182.23 244.83 183.84 241.388 186.419 238.966C183.834 235.738 181.249 232.03 178.859 227.789C176.391 223.418 174.553 219.242 173.17 215.469C171.787 219.242 169.949 223.418 167.481 227.789C165.091 232.03 162.506 235.738 159.921 238.966C162.5 241.388 164.11 244.83 164.11 248.649C164.11 255.975 158.168 261.917 150.842 261.917C143.51 261.917 137.567 255.975 137.567 248.649C137.567 246.239 138.21 243.992 139.321 242.044C131.157 237.368 122.987 232.685 114.817 228.003C119.792 235.108 125.585 244.921 130.092 257.39C135.411 272.1 137.113 285.446 137.483 295.552C137.249 295.591 137.009 295.629 136.775 295.668C134.255 296.11 132.567 298.513 133.008 301.033C133.443 303.553 135.846 305.241 138.366 304.806C147.277 303.254 159.967 302.364 173.17 302.364C186.373 302.364 199.063 303.254 207.974 304.806C208.24 304.852 208.506 304.871 208.772 304.871C210.98 304.871 212.942 303.286 213.331 301.033C213.773 298.513 212.085 296.11 209.558 295.668C209.324 295.629 209.091 295.591 208.85 295.552C209.227 285.446 210.929 272.1 216.247 257.39C220.755 244.921 226.541 235.108 231.522 228.003C223.352 232.685 215.182 237.368 207.012 242.044C208.129 243.992 208.766 246.246 208.766 248.649Z"
            fill="#D5B527"
          />
        </g>
      </g>
...
export const BriefcaseIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 0 1-2.25 2.25H5.92a2.25 2.25 0 0 1-2.25-2.25v-4.07a2.25 2.25 0 0 1 2.25-2.25h1.5a2.25 2.25 0 0 1 2.25 2.25v.62a2.25 2.25 0 0 0 2.25 2.25h3.52a2.25 2.25 0 0 0 2.25-2.25v-.62a2.25 2.25 0 0 1 2.25-2.25h1.5a2.25 2.25 0 0 1 2.25 2.25Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 21v-4.07a2.25 2.25 0 0 0-2.25-2.25h-5.52a2.25 2.25 0 0 0-2.25 2.25v4.07m10.5-11.25h.375c.621 0 1.125-.504 1.125-1.125V8.25c0-.621-.504-1.125-1.125-1.125h-3.75c-.621 0-1.125.504-1.125 1.125v.625c0 .621.504 1.125 1.125 1.125h.375m-3.75 0h.375c.621 0 1.125-.504 1.125-1.125V8.25c0-.621-.504-1.125-1.125-1.125h-3.75c-.621 0-1.125.504-1.125 1.125v.625c0 .621.504 1.125 1.125 1.125h.375m0 0h3.75" />
  </svg>
);
